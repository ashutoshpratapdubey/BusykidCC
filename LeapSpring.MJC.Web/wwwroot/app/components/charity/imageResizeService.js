mjcApp.service('imageResizeService', ['$q', '$document', '$window', function ($q, $document, $window) {
    var mainCanvas;
    var service = this;
     ...
     */
    this.resizeImage = function (src, options, minWidth, minHeight) {
        ...
        options = {
            ...
            outputFormat: options.outputFormat ? options.outputFormat : 'image/png',
